...
<head>
    ...
    <title>Benefice par jour - cooperative</title>
...
<body class="bg-light">
    ...
    <main class="py-5">
        <section class="container">
            <h2 class="text-center fw-bold text-dark mb-5 display-4">Liste des benefices obtenues par jour</h2>
                    ...
                    <article class="card h-100 shadow-sm border-0 text-center">
                        <section class="card-body p-4">
                            <table class="table table-light table-striped text-center">
                                ...
                                <?php 
                                    if(!empty($benefparjour)){
                                        foreach($benefparjour as $benef){

                                ?>
                                    <tr>
                                        <td><?= $benef['date_trajet_jr'] ?></td>
                                        <td><?= $benef['benef'] ?> Ar</td>
                                    </tr>
                                <?php
                                        }
                                    }
